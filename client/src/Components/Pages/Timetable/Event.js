...
class Event extends React.Component {
    ...
    render() {
        ...
        const offsetHours = this.getPos('0100', maxHeight) * 6;
        //const offsetHours = 0;
        ...
        return (
            <div className="event" style={{backgroundColor: this.props.data.color, top: startPos-offsetHours, height: height + 'px'}}>
